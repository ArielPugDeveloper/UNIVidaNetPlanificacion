...
{
    public partial class wfReprogramacionEncargadoSolicitudPOA : CWebFormGenerico
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                // Verificar permisos de acceso - Solo Encargado Responsable
                if (!CGestionPermisos.EsEncargadoResponsable())
                {
                    SwalError("Acceso Denegado", "Solo el Encargado Responsable puede acceder a esta página.");
        ...
        // Métodos de los botones de opciones del Encargado Responsable
